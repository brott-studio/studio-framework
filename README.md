...
Fresh agent sessions: start with [PIPELINE.md](PIPELINE.md), then read your role profile under [agents/](agents/). Escalation tiers and autonomy rules: [ESCALATION.md](ESCALATION.md).

---

*Maintained by The Bott (Executive Producer). Designed for AI agents.*
